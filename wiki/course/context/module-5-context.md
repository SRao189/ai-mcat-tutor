# Context Packet: chapter-3-summary
...
# Chapter 3: Biochemistry Basics — Summary
...
|-------|------------------|
| Enzymes/E<sub>a</sub> | Drill #1 |
| Redox reactions | Drill #2, #3 |
| pK<sub>a</sub>/mutations | Drill #4 |
| Basicity/pK<sub>a</sub> | Drill #5 |
| Bicarbonate buffer/breath holding | Drill #6 |
| Hemoglobin kinetics | Passage #1-4 |

---

*Source: Princeton Review MCAT Biochemistry Review, Chapter 3*
...
[
  ...
  },
  {
    ...
    "type": "topic",
    "name": "Biochemistry",
    "summary": "Category from index: Biochemistry (0 articles)",
    "tags": [
      "category"
    ],
    "complexity": "simple"
  },
  {
    ...
    "type": "topic",
    "name": "Content Review",
    "summary": "Category from index: Content Review (0 articles)",
    "tags": [
      "category"
    ],
    "complexity": "simple"
  },
  {
    ...
    "type": "entity",
    "name": "ATP",
    "summary": "Adenosine triphosphate, the primary energy currency of cells; hydrolysis yields ~ -30.5 kJ/mol under standard conditions",
    "tags": [
      "entity",
      "biochemistry",
      "molecule"
  ...
  {
    "id": "entity:glucose-oxidation",
    "type": "entity",
    "name": "Glucose Oxidation",
    "summary": "Complete oxidation of glucose: C6H12O6 + 6O2 → 6CO2 + 6H2O, the central catabolic pathway yielding ~ -2870 kJ/mol",
    "tags": [
      "entity",
      "biochemistry",
      "metabolism",
  ...
  {
    "id": "claim:oxidation-reduction:oil-rig",
    "type": "claim",
    "name": "OIL RIG Mnemonic for Redox",
    "summary": "Oxidation Is Loss, Reduction Is Gain — of electrons, oxygen, or hydrogen",
    "tags": [
      "claim",
      "biochemistry",
      "redox",
  ...
  {
    "id": "claim:oxidation-reduction:redox-coupled",
    "type": "claim",
    "name": "Redox Reactions Are Always Coupled",
    "summary": "Oxidation and reduction half-reactions occur simultaneously; electrons lost by one species are gained by another",
    "tags": [
      "claim",
      "biochemistry",
      "redox"
  ...
  {
    "id": "claim:oxidation-reduction:catabolism-oxidative",
    "type": "claim",
    "name": "Catabolism Is Oxidative, Anabolism Is Reductive",
    "summary": "Catabolic pathways oxidize fuels (loss of electrons/H, gain of O); anabolic pathways reduce building blocks (gain of electrons/H, loss of O)",
    "tags": [
      "claim",
      "biochemistry",
      "redox",
  ...
  {
    "id": "claim:oxidation-reduction:fatty-acid-synthesis-reductive",
    "type": "claim",
    "name": "Fatty Acid Synthesis Is a Reductive Process",
    "summary": "Fatty acid synthesis consumes NADPH (reducing equivalents) to build reduced carbon chains from acetyl-CoA",
    "tags": [
      "claim",
      "biochemistry",
      "redox",
  ...
  {
    "id": "entity:bronsted-lowry",
    "type": "entity",
    "name": "Brønsted-Lowry theory",
    "summary": "Acid-base theory defining acids as proton donors and bases as proton acceptors; noted as most important for MCAT",
    "tags": [
      "entity",
      "biochemistry",
      "acid-base-theory"
  ...
  {
    "id": "entity:lewis-acid-base",
    "type": "entity",
    "name": "Lewis acid-base theory",
    "summary": "Broader acid-base theory defining acids as electron-pair acceptors and bases as electron-pair donors; forms coordinate covalent bonds",
    "tags": [
      "entity",
      "biochemistry",
      "acid-base-theory"
  ...
  {
    "id": "entity:lactic-acid",
    "type": "entity",
    "name": "Lactic acid",
    "summary": "Weak acid (pKa = 3.9) produced by muscles during exercise; contributes to H+ increase buffered by bicarbonate system",
    "tags": [
      "entity",
      "biochemistry",
      "metabolite"
  ...
  {
    "id": "entity:amino-acids",
    "type": "entity",
    "name": "Amino acids",
    "summary": "All amino acids are amphoteric — can act as both acid and base due to carboxyl and amino groups",
    "tags": [
      "entity",
      "biochemistry",
      "macromolecules"
  ...
  {
    "id": "entity:bicarbonate-buffer-system",
    "type": "entity",
    "name": "Bicarbonate buffer system",
    "summary": "Primary blood buffer: CO2 + H2O ⇌ H2CO3 ⇌ H+ + HCO3-; resists pH changes from metabolic acids and respiratory CO2",
    "tags": [
      "entity",
      "biochemistry",
      "physiology"
  ...
  {
    "id": "entity:princeton-review",
    "type": "entity",
    "name": "Princeton Review",
    "summary": "MCAT prep publisher; source of Chapter 3 Biochemistry Review content",
    "tags": [
      "entity",
      "source",
      "education"
  ...
  {
    "id": "claim:acids-bases:bl-most-important-mcat",
    "type": "claim",
    "name": "Brønsted-Lowry is most important for MCAT",
    "summary": "The Brønsted-Lowry definition (acid = H+ donor, base = H+ acceptor) is explicitly noted as the most important acid-base theory for the MCAT exam",
    "tags": [
      "claim",
      "biochemistry",
      "mcat-guidance"
  ...
  {
    "id": "claim:acids-bases:polyprotic-conj-base-amphoteric",
    "type": "claim",
    "name": "Conjugate base of weak polyprotic acid is always amphoteric",
    "summary": "The conjugate base of any weak polyprotic acid can act as both acid and base (e.g., HCO3- from H2CO3)",
    "tags": [
      "claim",
      "biochemistry",
      "acid-base"
  ...
  {
    "id": "claim:acids-bases:exercise-lactic-acid-buffering",
    "type": "claim",
    "name": "Exercise lactic acid buffered by bicarbonate system via Le Chatelier",
    "summary": "During exercise, muscles produce lactic acid increasing H+; bicarbonate buffer reaction (H2CO3 ⇌ H+ + HCO3-) shifts left per Le Chatelier's principle, consuming free H+ and minimizing pH drop",
    "tags": [
      "claim",
      "biochemistry",
      "physiology"
  ...
  {
    "id": "claim:acids-bases:breath-holding-co2-lowens-ph",
    "type": "claim",
    "name": "Breath holding increases CO2 and decreases blood pH",
    "summary": "Holding breath causes CO2 accumulation, driving CO2 + H2O ⇌ H2CO3 right, producing more H2CO3 which dissociates to H+ + HCO3-, lowering blood pH",
    "tags": [
      "claim",
      "biochemistry",
      "physiology"
  ...
  {
    "id": "claim:acids-bases:lower-pka-stronger-acid",
    "type": "claim",
    "name": "Lower pKa indicates stronger acid",
    "summary": "pKa = -log Ka; lower pKa value corresponds to larger Ka and thus stronger acid (e.g., lactic acid pKa 3.9 > uric acid pKa 5.6 in acidity)",
    "tags": [
      "claim",
      "biochemistry",
      "acid-strength"
  ...
  {
    "id": "claim:chapter-3-summary:catabolism-oxidative-anabolism-reductive",
    "type": "claim",
    "name": "Catabolism is oxidative; anabolism is reductive",
    "summary": "Catabolic pathways release energy via oxidation; anabolic pathways require energy (ATP) and proceed via reduction",
    "tags": [
      "claim",
      "biochemistry",
      "metabolism"
  ...
  {
    "id": "claim:chapter-3-summary:bicarbonate-main-blood-buffer",
    "type": "claim",
    "name": "Bicarbonate buffer is the main blood buffer",
    "summary": "The bicarbonate buffer system (CO2 + H2O ⇌ H2CO3 ⇌ H+ + HCO3-) is the primary buffer in blood; CO2 accumulation from breath-holding lowers pH",
    "tags": [
      "claim",
      "biochemistry",
      "physiology"
